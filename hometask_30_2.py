...
# 2. Використовуючи API для погоди https://open-meteo.com/en/docs, написати програму,
# яка буде приймати від користувача назву міста і виводити поточні показники погоди в консоль.
